...
export const projects: Project[] = [
  {
    title: "Convo Sparks",
    description: "Conversation topics that spark connection, reflection, and joy",
    github: null,
    live: "https://convosparks.com"
  },
  {
    title: "USPS Mail Alerts Apps Script",
    description: "Automatically create Google Tasks reminders based on USPS Informed Delivery emails",
